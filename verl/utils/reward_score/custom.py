...
def normal_rf1(answer,ground_truth):
...
def compute_score(solution_str, ground_truth,solution_len) -> float:
    retval = -10
    ...
    if match: 
        ...
        if string_in_last_boxed: 
            # print(solution_str)
            # print(string_in_last_boxed)
            answer = remove_boxed(string_in_last_boxed)
            if answer ==None:
                return retval+0.5 
            retval = normal_rf1(answer,ground_truth)
