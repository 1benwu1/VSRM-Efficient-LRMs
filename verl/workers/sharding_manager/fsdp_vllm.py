...
class FSDPVLLMShardingManager(BaseShardingManager):
    ...
    def __init__(
        ...
        self.model_runner = inference_engine.llm_engine.model_executor.driver_worker.worker.model_runner if inference_engine else None # 这里
# File "/workdir/verl/workers/sharding_manager/fsdp_vllm.py", line 53, in __init__
...
# AttributeError: 'SPMDGPUExecutor' object has no attribute 'driver_worker'
# inference_engine是rollout.inference_engine的实例,而这其实就是一个vllm的LLM实例，在thrid party下面
# 
# 
